...
''' DUTY_LIST SUBSCRIPTION'''
'''
This script subscribes to the duty_list topic
on Google Cloud. The received input is written
to a text file, which is then read by the interface.py
script to perform the light operations.
'''
