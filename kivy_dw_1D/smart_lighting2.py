...
<<<<<<< HEAD
        ...
        self.ids.rt_localstat1_l0.text   = "{}%".format(float(duty_val[0]))
        
        self.ids.rt_localstat1_l1.text   = "{}percent".format(duty_val[1] * 100)
        '''
        self.ids.rt_localstat1_l0.text   = "{}%".format(duty_val[2] * 100)
        self.ids.rt_localstat1_l1.text   = "{}%".format(duty_val[2] * 100)
...
>>>>>>> 6471910289223cab99bb8b4d57a840cb5ef95523
