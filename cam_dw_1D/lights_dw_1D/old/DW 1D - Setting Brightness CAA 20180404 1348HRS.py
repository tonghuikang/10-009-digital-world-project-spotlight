...
'''
#camera range is 600 x 450 (i.e. step 150, 112)
#coordinates of the LEDS
p1 = LED_coord(150,112,19)  #top left
p2 = LED_coord(150,225,5)   #top mid
p3 = LED_coord(150,338,13)  #top right
p4 = LED_coord(300,112,26)  #mid left
p5 = LED_coord(300,338,12)  #mid right
p6 = LED_coord(450,112,21)  #bottom left
p7 = LED_coord(450,225,20)  #bottom mid
p8 = LED_coord(450,338,16)  #bottom right
